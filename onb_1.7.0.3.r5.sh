...
BIGIP_DCO_JS='{
	...
	"myDns": {
        ...
        "failoverGroup": {
			...
			"members": ["'"$COUNTRY"''"$LOCALITY"'VEcc'"$CUSTOMER_CC"'001.'"$LOCALITY"'.ecs.hp.com", "'"$COUNTRY"''"$LOCALITY"'VEcc'"$CUSTOMER_CC"'002.'"$LOCALITY"'.ecs.hp.com", "'"$COUNTRY"''"$LOCALITY"'VEcc'"$CUSTOMER_CC"'003.'"$LOCALITY"'.ecs.hp.com"],
